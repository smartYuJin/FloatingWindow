...
public class TopWindowService extends Service {
    public static final String TAG = "TopWindowService";
    public static final String OPERATION = "operation";
    public static final int OPERATION_SHOW = 100;
    public static final int OPERATION_HIDE = 101;

    private static final int HANDLE_CHECK_ACTIVITY = 200;
    private static final int HANDLE_SHOW_WINDOW = 201;
    private static final int HANDLE_HID_WINDOW = 202;
...
//            mHandler.removeMessages(HANDLE_CHECK_ACTIVITY);
        ...
        case OPERATION_HIDE:
//            mHandler.removeMessages(HANDLE_CHECK_ACTIVITY);
            mHandler.sendEmptyMessage(HANDLE_HID_WINDOW);
            break;
        }
    }
